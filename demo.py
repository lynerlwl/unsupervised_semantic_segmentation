...
def run():
    ...
    parser.add_argument('--algo', default="felz", help='felz or slic')
    parser.add_argument('--optim', default="sgd", help='sgd or rms')
    parser.add_argument('--visualize', default=1, type=int, help='1 - true, 0 - no') 
    parser.add_argument('--train_epoch', default=2 ** 6, type=int) 
    parser.add_argument('--mod_dim1', default=64, type=int) 
    parser.add_argument('--mod_dim2', default=32, type=int)
    parser.add_argument('--gpu_id', default=0, type=int)                                                             
    parser.add_argument('--min_label_num', default=4, type=int, help='if the label number small than it, break loop')                                                             
    parser.add_argument('--max_label_num', default=256, type=int, help='if the label number small than it, start to show result image')                                                             
    ...
    cv2.imwrite("seg_%s_%ds.png" % (args.input[6:-4], time1), show)
